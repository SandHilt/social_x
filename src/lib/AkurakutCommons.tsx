...
//   children: ReactNode
//   href?: PropsWithChildren<LinkProps>[]
// }
...
// ================================================================================================================
export function AlurakutProfileSidebarMenuDefault(): ReactElement {
  return (
    <AlurakutProfileSidebarMenuDefault.Wrapper>
      <nav>
        <a href="/">
          <img src={`${BASE_URL}/icons/user.svg`} alt="icone de usuário" />
          Perfil
        </a>
        <a href="/">
          <img src={`${BASE_URL}/icons/book.svg`} alt="icone do livro" />
          Recados
        </a>
        <a href="/">
          <img src={`${BASE_URL}/icons/camera.svg`} alt="icone de câmera" />
          Fotos
        </a>
        <a href="/">
          <img src={`${BASE_URL}/icons/sun.svg`} alt="icone do sol" />
          Depoimentos
        </a>
      </nav>
      <hr />
      <nav>
        <a href="/">
          <img src={`${BASE_URL}/icons/plus.svg`} alt="icone de mais" />
          GitHub Trends
        </a>
        <a href="/logout">
          <img src={`${BASE_URL}//icons/logout.svg`} alt="icone de sair" />
          Sair
        </a>
      </nav>
    </AlurakutProfileSidebarMenuDefault.Wrapper>
...
// Menu
// ================================================================================================================
interface AlurakutGitHubName {
  githubUser: string
}

interface AlurakutMenuStyledProps {
  isMenuOpen: boolean
}

function AlurakutMenuProfileSidebar({
  githubUser,
}: AlurakutGitHubName): ReactElement {
  return (
...
export function AlurakutMenu({ githubUser }: AlurakutGitHubName): ReactElement {
    ...
    <AlurakutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        ...
        <button type="button" onClick={() => setMenuState(!isMenuOpen)}>
          {isMenuOpen && (
            <img
              alt="icone do menu aberto"
              src={`${BASE_URL}/icons/menu-open.svg?v=${v}`}
            />
          )}
          {!isMenuOpen && (
            <img
              alt="icone do menu fechado"
...
AlurakutMenu.Wrapper = styled.header<AlurakutMenuStyledProps>`
  width: 100%;
